...
const Hero = () => {
    return (
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} p-3`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 md:px-16 px-6`}>
                ...
                <div className="flex flex-row justify-between items-center w-full">
                    <h1 className="flex-1 font-popins font-semibold ss:text-[72px] text-[52px] text-white ss:leading[100px] leading-[70px]">
                        The Next WOW<br className="sm:block hidden" /> {" "}
                        <span className="text-gradient">Generation</span> {" "} <br className="sm:block hidden" />
                    </h1>
                    <div className="ss:flex hidden md:mr-4 mr-10">
                        <GetStarted />
                    </div>
                </div>
                <h1 className="font-popins font-semibold ss:text-[68px] text-[52px] text-white ss:leading[100px] leading-[70px]">Payment Method.</h1>
